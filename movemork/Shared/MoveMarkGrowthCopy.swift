...
enum MoveMarkGrowthCopy {
    ...
    static let welcomeBody = "Take room photos before you unpack. Turn them into a report when you need it."
    static let welcomePainLine = "Old damage can cost you your deposit — unless you have proof."
