...
fun RoomsScreen(
    ...
    Column(
        ...
        Text("Rooms", style = androidx.compose.material3.MaterialTheme.typography.headlineLarge)
        ...
        when {
            ...
            property == null -> Text("No rooms loaded.", color = MMColors.TextSecondary)
                ...
                Text(
                    "$documented of ${p.rooms.size} rooms documented",
                ...
                p.rooms.forEachIndexed { index, room ->
                    MMRoomProofRow(
                        ...
                        modifier = Modifier.clickable { onOpenRoom(room.id) },
                    )
                }
            }
        }
